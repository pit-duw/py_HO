  ...
  set label "{/Symbol @\326\140}S=   5.02TeV, -1.40<y<  0.40" font ",14" at graph 0.1, graph 0.94
  ...
  set label "{/Symbol @\326\140}S=   8.02TeV, -4.50<y< -3.00" font ",14" at graph 0.1, graph 0.94
  ...
  set label "{/Symbol @\326\140}S=   8.02TeV,  2.00<y<  3.50" font ",14" at graph 0.1, graph 0.94
