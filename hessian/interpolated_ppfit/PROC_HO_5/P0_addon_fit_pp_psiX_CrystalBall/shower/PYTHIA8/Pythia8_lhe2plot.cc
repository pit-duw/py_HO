...
extern "C" { 
  void __plot_py8_user_MOD_plot_py8_begin(int&,char(*)[15]);
  void __plot_py8_user_MOD_plot_py8_end(double&);
  void __plot_py8_user_MOD_plot_py8_fill(double(*));
}
...
int main() {
  ...
  __plot_py8_user_MOD_plot_py8_begin(cwgtinfo_nn,cwgtinfo_weights_info);
  ...
  for (int iEvent = 0; ; ++iEvent) {
    ...
    __plot_py8_user_MOD_plot_py8_fill(cwgt_ww);
  ...
  __plot_py8_user_MOD_plot_py8_end(norm);
