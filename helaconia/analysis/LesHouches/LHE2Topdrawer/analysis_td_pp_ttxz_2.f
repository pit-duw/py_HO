c
c Example analysis for "p p > t t~ z" process.
c
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      character*7 cc(6)
      data cc/'pp LO  ','cuts100','cuts200','cuts300','cuts500',
     $     'cut1000'/
      double precision pi
     ...
     &       //weights_info(kk)//cc(i),10.d0,0.d0,5000.d0)
        call bookup(l+ 7,'minv tz       '
     &       //weights_info(kk)//cc(i),10.d0,0.d0,5000.d0)
        call bookup(l+ 8,'t pt             '
     &       //weights_info(kk)//cc(i),10.d0,0.d0,5000.d0)
        call bookup(l+ 9,'z pt        '
     &       //weights_info(kk)//cc(i),10.d0,0.d0,5000.d0)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      do i=1,6
        ...
        call multitop(l+ 7,2,3,'minv tz',' ','LOG')
        call multitop(l+ 8,2,3,'t pt',' ','LOG')
        call multitop(l+ 9,2,3,'pt z',' ','LOG')
        ...
        call multitop(l+15,2,3,'delta(y_tt,z)',' ','LOG')
        call multitop(l+16,2,3,'t y',' ','LOG')
        call multitop(l+17,2,3,'tt log[pi-azimt]',' ','LOG')
        call multitop(l+18,2,3,'tt ptz',' ','LOG')
        call multitop(l+19,2,3,'minv tot',' ','LOG')
        call multitop(l+20,2,3,'minv tx z',' ','LOG')
      enddo
      enddo
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     . ugflag,dgflag,cutflag100,cutflag200,cutflag300
     .     ,cutflag500,cutflag1000
