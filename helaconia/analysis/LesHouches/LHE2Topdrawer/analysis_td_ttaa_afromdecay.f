c
c Example analysis for "p p > t t~ a a, (t > w+ b),(t > w- b~)" process.
c
...
C      common/plot_analy/idim,n_plot
     ...
     &       //weights_info(kk)//cc(i),0.01d0,120.d0,130.d0)
...
C      cutflag=siq1flag.and.siq2flag.and.siq3flag
     ...
     &     .AND.minvaa.GE.120d0.AND.minvaa.LE.130d0
     &     .AND.(minvwpb.GT.163d0.AND.minvwpb.LT.183d0)
     &     .AND.(minvwmbx.GT.163d0.AND.minvwmbx.LT.183d0)
