...
public:
  ...
  HEPTopTagger(const fjcore::ClusterSequence & cs,
...
private:
  ...
  void FindHardSubst(const PseudoJet& jet, vector<fjcore::PseudoJet>& t_parts);
  ...
  bool check_mass_criteria(const vector<fjcore::PseudoJet> & top_subs) const;
  ...
  double r_max_3jets(const fjcore::PseudoJet & jet1,const fjcore::PseudoJet & jet2,
		     const fjcore::PseudoJet & jet3) const;
};
//--------------------------------------------------------------------
...
double HEPTopTagger::r_max_3jets(const fjcore::PseudoJet & jet1,const fjcore::PseudoJet & jet2,const fjcore::PseudoJet & jet3) const{
  fjcore::PseudoJet jet12,jet13,jet23;
  jet12=jet1+jet2;
  jet13=jet1+jet3;
  jet23=jet2+jet3;
...
void HEPTopTagger::FindHardSubst(const PseudoJet & this_jet, vector<fjcore::PseudoJet> & t_parts)
{
...
////////// Top-TAGGER: /////////////////////////////////////////////////////////////////
HEPTopTagger::HEPTopTagger(const fjcore::ClusterSequence & cs,
			   const fjcore::PseudoJet & jet) : 
...
{
  // perform filtering
  fjcore::ClusterSequence cstopfilt( top_constits, filtering_def);
