SUBROUTINE strf_lhapdf_fit_cb(wsf)
USE fit_cb_global
USE Helac_Global
...
CALL pftopdglha(ih,fit_xp1,scale,pdflist(-7:7))
...
CALL pftopdglha(ih,fit_xp2,scale,pdflist(-7:7))
...
END SUBROUTINE strf_lhapdf_fit_cb
