################################################################################
#
# Original shower_card.py file in MadGraph5_aMC@NLO
# Copyright (c) 2011 The MadGraph5_aMC@NLO Development team and Contributors
#
# Changed by Hua-Sheng Shao, 08 Dec 2014
#
################################################################################
...
class ShowerCard(dict):
    ...
    names_dict = {\
            ...
            'maxerrs' : {'HERWIG6':'err_num_hw', 'PYTHIA6': 'err_num_py', 'HERWIGPP': 'err_num_hwpp', 'PYTHIA8': 'err_num_py8'},
    ...
    stdhep_dict = {'HERWIG6':'helaconia_hwan_stdhep.o', 'PYTHIA6':'helaconia_pyan_stdhep.o'}
    ...
    def write_card(self, shower, card_path=None):
