      subroutine fastjetppgenkt_timed(pQCD,NN,rfj,sycut,palg,
     &pjet,njet,jet)
...
c     timing statistics
      ...
      call fastjetppgenkt(pQCD,NN,rfj,sycut,palg,
     &pjet,njet,jet)
      ...
      subroutine fastjetppgenkt_etamax_timed(
